...
'''
ubuntu@huzhi-ubuntu3:~/www/diy_framework/asyncio$ python3 16.py 
Waiting:  1
Waiting:  2
Waiting:  4
^Cstop loop!
{<Task pending coro=<do_some_work() running at 16.py:12> wait_for=<Future pending cb=[Task._wakeup()]> cb=[_wait.<locals>._on_completion() at /usr/lib/python3.5/asyncio/tasks.py:414]>, <Task pending coro=<do_some_work() running at 16.py:12> wait_for=<Future pending cb=[Task._wakeup()]> cb=[_wait.<locals>._on_completion() at /usr/lib/python3.5/asyncio/tasks.py:414]>, <Task pending coro=<wait() running at /usr/lib/python3.5/asyncio/tasks.py:347> wait_for=<Future pending cb=[Task._wakeup()]> cb=[_run_until_complete_cb() at /usr/lib/python3.5/asyncio/base_events.py:164]>, <Task pending coro=<do_some_work() running at 16.py:12> wait_for=<Future pending cb=[Task._wakeup()]> cb=[_wait.<locals>._on_completion() at /usr/lib/python3.5/asyncio/tasks.py:414]>}

<Task pending coro=<do_some_work() running at 16.py:12> wait_for=<Future pending cb=[Task._wakeup()]> cb=[_wait.<locals>._on_completion() at /usr/lib/python3.5/asyncio/tasks.py:414]>
True
